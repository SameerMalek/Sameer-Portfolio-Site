...
export const hero = {
  h1: "I build production-grade, secure AI systems, then stay long enough to watch real businesses run on them.",
  sub: "I'm a Forward-Deployed AI Engineer and co-founder of Orchestrator, a Calgary AI and automation studio. I embed with clients, take a messy idea to a deployed system, and stay until it runs their business.",
